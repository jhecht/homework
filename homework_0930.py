...
#     for n in string:
#         someString = n + someString
#     return someString
#
# def palindrome_test(somestring):
#     if string == reverse(reverse_string):
...
#         if some_numlist[x] % some_numlist[0] == 0:
#             result = result + 'y'
#         else:
#             result = result + 'n'
#     # print result
...
#     print 'None'
# else:
#     if (geometric(numlist) == 1) and (arithmetic(numlist) == 1):
#         print 'Geometric & Arithmetic'
...
#
#
# def amalgram(somestr1,somestr2):
#     x=0
...
#             else:
#                 x +=1
#                 #how do I make it print True only once??
#                 #print 'True.'
#                 # in_string = in_string + str2[x]
#
#     if x == len(somestr2):
#         print 'True'
#
...
str = 'This WuZ an 1nterest1ng eXerciZe!'
num = 1
...
# print x
#
# y = alphabet.index('h') + 2 -- returns 9
# print y
# print alphabet[2] -- returns c
x=0
new_str=''
# print str.index(str[0]) -- returns 0
# print alphabet[25] -- returns z
